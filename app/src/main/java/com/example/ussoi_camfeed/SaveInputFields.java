...
public class SaveInputFields {
    ...
    public void restorePreferences(Switch btSwitch, Switch videoSwitch ,EditText baudrate, EditText ip, CheckBox http_checkbox, CheckBox websocket_checkbox) {
    ...
    public void savePreferences(boolean btOn, boolean videoOn, EditText baudrate, EditText ip, boolean http, boolean websocket){
